...
var _useHistory2 = _interopRequireDefault(require("../hooks/useHistory"));

var _historyShape = _interopRequireDefault(require("../historyShape"));
...
var Wizard = function Wizard(_ref) {
  ...
  var getStepFromPath = function getStepFromPath(path) {
  ...
  var _useHistory = (0, _useHistory2.default)({
    ...
    exactMatch: exactMatch
      ...
      pathname = _useHistory.pathname,
      wizardHistory = _objectWithoutProperties(_useHistory, _excluded);
  ...
  var step = getStepFromPath(pathname);
  var indexOfStep = steps.indexOf(step);

  var wizard = _objectSpread({
    step: step,
    steps: steps,
    onNext: handleNext,
